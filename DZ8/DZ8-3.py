...
while True:
    try:
        a = input("Введите число для продолжения, или пробел для завершения: ")
        if a == ' ':
            print("Программа завершена")
            break
        elif a.isdigit():
            my_list.append(int(a))
        else: raise Num_test("Вы ввели некорректное значение")
    except Num_test as err:
        print(err)
print(my_list)
